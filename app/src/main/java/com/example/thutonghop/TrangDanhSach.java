...
public class TrangDanhSach extends AppCompatActivity {
   ...
   DienThoaiAdapter adapter;
    ...
    private void AnhXa () {
        ...
        arrayDienthoai.add(new DienThoai("IPHONE 9", "Cấu hình và hiệu năng", R.drawable.iphone9));
        arrayDienthoai.add(new DienThoai("IPHONE 11", "Thời lượng pin", R.drawable.iphone8));
        arrayDienthoai.add(new DienThoai("IPHONE 12" , "Tổng kết", R.drawable.iphone12));
